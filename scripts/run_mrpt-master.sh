...
echo "======================================"
echo "MRPT Master PPA Build Script"
echo "Started: $(date)"
echo "======================================"
...
LOCKFILE=${LOCKFILE:-/var/cache/mrpt-ppa/mrptppa-master.lock}
SHA_CACHE_FILE=${SHA_CACHE_FILE:-/var/cache/mrpt-ppa/mrptppa-master.sha}
...
echo "======================================"
echo "MRPT Master build script completed"
echo "Finished: $(date)"
echo "======================================"